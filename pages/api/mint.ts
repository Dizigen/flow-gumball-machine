...
const mint = async (contractAddress: string, account: string, privateKey: string) => {
...
export default function handler(
  ...
  res: NextApiResponse<Data>
    ...
    mint(req.headers.contract_address as string, req.headers.account as string, req.headers.pk as string).then(nftTokenId => {
